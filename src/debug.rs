    ...
    pub fn new(
        ...
        Self {
            cpu: CpuSnapshot {
                ...
                flags_n: cpu.p.contains(crate::cpu::Flags::N),
                flags_v: cpu.p.contains(crate::cpu::Flags::V),
                flags_b: cpu.p.contains(crate::cpu::Flags::B),
                flags_d: cpu.p.contains(crate::cpu::Flags::D),
                flags_i: cpu.p.contains(crate::cpu::Flags::I),
                flags_z: cpu.p.contains(crate::cpu::Flags::Z),
                flags_c: cpu.p.contains(crate::cpu::Flags::C),
                log: log_string,
            },
            ppu: PpuSnapshot {
                dot: ppu.dot,
