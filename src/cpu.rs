...
static OPCODES: phf::Map<u8, Op> = phf_map! {
    ...
    0xA4u8 => op!(OpMnemonic::LDY, AddressingMode::ZeroPage   , 3, Cpu::ldy),
    0xB4u8 => op!(OpMnemonic::LDY, AddressingMode::ZeroPageX  , 4, Cpu::ldy),
    ...
    0x65u8 => op!(OpMnemonic::ADC, AddressingMode::ZeroPage   , 3, Cpu::adc),
    0x75u8 => op!(OpMnemonic::ADC, AddressingMode::ZeroPageX  , 4, Cpu::adc),
    0x6Du8 => op!(OpMnemonic::ADC, AddressingMode::Absolute   , 4, Cpu::adc),
    0x7Du8 => op!(OpMnemonic::ADC, AddressingMode::AbsoluteX  , 4, Cpu::adc),
    0x79u8 => op!(OpMnemonic::ADC, AddressingMode::AbsoluteY  , 4, Cpu::adc),
    0x61u8 => op!(OpMnemonic::ADC, AddressingMode::IndirectX  , 6, Cpu::adc),
    0x71u8 => op!(OpMnemonic::ADC, AddressingMode::IndirectY  , 5, Cpu::adc),
    0xE9u8 => op!(OpMnemonic::SBC, AddressingMode::Immediate  , 2, Cpu::sbc),
    0xE5u8 => op!(OpMnemonic::SBC, AddressingMode::ZeroPage   , 3, Cpu::sbc),
    0xF5u8 => op!(OpMnemonic::SBC, AddressingMode::ZeroPageX  , 4, Cpu::sbc),
    0xEDu8 => op!(OpMnemonic::SBC, AddressingMode::Absolute   , 4, Cpu::sbc),
    0xFDu8 => op!(OpMnemonic::SBC, AddressingMode::AbsoluteX  , 4, Cpu::sbc),
    ...
    0x06u8 => op!(OpMnemonic::ASL, AddressingMode::ZeroPage,    5, Cpu::asl),
    0x16u8 => op!(OpMnemonic::ASL, AddressingMode::ZeroPageX,   6, Cpu::asl),
    0x0Eu8 => op!(OpMnemonic::ASL, AddressingMode::Absolute,    6, Cpu::asl),
    0x1Eu8 => op!(OpMnemonic::ASL, AddressingMode::AbsoluteX,   7, Cpu::asl),
    0x4Au8 => op!(OpMnemonic::LSR, AddressingMode::Accumulator, 2, Cpu::lsr),
    0x46u8 => op!(OpMnemonic::LSR, AddressingMode::ZeroPage,    5, Cpu::lsr),
    0x56u8 => op!(OpMnemonic::LSR, AddressingMode::ZeroPageX,   6, Cpu::lsr),
    0x4Eu8 => op!(OpMnemonic::LSR, AddressingMode::Absolute,    6, Cpu::lsr),
    0x5Eu8 => op!(OpMnemonic::LSR, AddressingMode::AbsoluteX,   7, Cpu::lsr),
    0x2Au8 => op!(OpMnemonic::ROL, AddressingMode::Accumulator, 2, Cpu::rol),
    0x26u8 => op!(OpMnemonic::ROL, AddressingMode::ZeroPage,    5, Cpu::rol),
    0x36u8 => op!(OpMnemonic::ROL, AddressingMode::ZeroPageX,   6, Cpu::rol),
    0x2Eu8 => op!(OpMnemonic::ROL, AddressingMode::Absolute,    6, Cpu::rol),
    0x3Eu8 => op!(OpMnemonic::ROL, AddressingMode::AbsoluteX,   7, Cpu::rol),
    0x6Au8 => op!(OpMnemonic::ROR, AddressingMode::Accumulator, 2, Cpu::ror),
    0x66u8 => op!(OpMnemonic::ROR, AddressingMode::ZeroPage,    5, Cpu::ror),
    0x76u8 => op!(OpMnemonic::ROR, AddressingMode::ZeroPageX,   6, Cpu::ror),
    0x6Eu8 => op!(OpMnemonic::ROR, AddressingMode::Absolute,    6, Cpu::ror),
    0x7Eu8 => op!(OpMnemonic::ROR, AddressingMode::AbsoluteX,   7, Cpu::ror),
    0x29u8 => op!(OpMnemonic::AND, AddressingMode::Immediate  , 2, Cpu::and),
    0x25u8 => op!(OpMnemonic::AND, AddressingMode::ZeroPage   , 3, Cpu::and),
    0x35u8 => op!(OpMnemonic::AND, AddressingMode::ZeroPageX  , 4, Cpu::and),
    0x2Du8 => op!(OpMnemonic::AND, AddressingMode::Absolute   , 4, Cpu::and),
    0x3Du8 => op!(OpMnemonic::AND, AddressingMode::AbsoluteX  , 4, Cpu::and),
    0x39u8 => op!(OpMnemonic::AND, AddressingMode::AbsoluteY  , 4, Cpu::and),
    0x21u8 => op!(OpMnemonic::AND, AddressingMode::IndirectX  , 6, Cpu::and),
    0x31u8 => op!(OpMnemonic::AND, AddressingMode::IndirectY  , 5, Cpu::and),
    0x09u8 => op!(OpMnemonic::ORA, AddressingMode::Immediate  , 2, Cpu::ora),
    0x05u8 => op!(OpMnemonic::ORA, AddressingMode::ZeroPage   , 3, Cpu::ora),
    0x15u8 => op!(OpMnemonic::ORA, AddressingMode::ZeroPageX  , 4, Cpu::ora),
    0x0Du8 => op!(OpMnemonic::ORA, AddressingMode::Absolute   , 4, Cpu::ora),
    0x1Du8 => op!(OpMnemonic::ORA, AddressingMode::AbsoluteX  , 4, Cpu::ora),
    0x19u8 => op!(OpMnemonic::ORA, AddressingMode::AbsoluteY  , 4, Cpu::ora),
    0x01u8 => op!(OpMnemonic::ORA, AddressingMode::IndirectX  , 6, Cpu::ora),
    0x11u8 => op!(OpMnemonic::ORA, AddressingMode::IndirectY  , 5, Cpu::ora),
    0x49u8 => op!(OpMnemonic::EOR, AddressingMode::Immediate  , 2, Cpu::eor),
    0x45u8 => op!(OpMnemonic::EOR, AddressingMode::ZeroPage   , 3, Cpu::eor),
    0x55u8 => op!(OpMnemonic::EOR, AddressingMode::ZeroPageX  , 4, Cpu::eor),
    0x4Du8 => op!(OpMnemonic::EOR, AddressingMode::Absolute   , 4, Cpu::eor),
    0x5Du8 => op!(OpMnemonic::EOR, AddressingMode::AbsoluteX  , 4, Cpu::eor),
    0x59u8 => op!(OpMnemonic::EOR, AddressingMode::AbsoluteY  , 4, Cpu::eor),
    ...
    0xCDu8 => op!(OpMnemonic::CMP, AddressingMode::Absolute   , 4, Cpu::cmp),
    0xDDu8 => op!(OpMnemonic::CMP, AddressingMode::AbsoluteX  , 4, Cpu::cmp),
    0xD9u8 => op!(OpMnemonic::CMP, AddressingMode::AbsoluteY  , 4, Cpu::cmp),
    0xC1u8 => op!(OpMnemonic::CMP, AddressingMode::IndirectX  , 6, Cpu::cmp),
    0xD1u8 => op!(OpMnemonic::CMP, AddressingMode::IndirectY  , 5, Cpu::cmp),
    0xE0u8 => op!(OpMnemonic::CPX, AddressingMode::Immediate  , 2, Cpu::cpx),
    0xE4u8 => op!(OpMnemonic::CPX, AddressingMode::ZeroPage   , 3, Cpu::cpx),
    0xECu8 => op!(OpMnemonic::CPX, AddressingMode::Absolute   , 4, Cpu::cpx),
    0xC0u8 => op!(OpMnemonic::CPY, AddressingMode::Immediate  , 2, Cpu::cpy),
    0xC4u8 => op!(OpMnemonic::CPY, AddressingMode::ZeroPage   , 3, Cpu::cpy),
    0xCCu8 => op!(OpMnemonic::CPY, AddressingMode::Absolute   , 4, Cpu::cpy),
